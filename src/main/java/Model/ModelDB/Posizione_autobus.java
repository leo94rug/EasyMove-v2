 ...
 * @author leo
 */
public class Posizione_autobus {
    ...
    public Posizione_autobus(JSONObject jsonObject) throws JSONException {
    ...
    public Posizione_autobus(String nome) {
        this.nome = nome;
    }
    public Posizione_autobus(ResultSet rs) throws SQLException {
    ...
    public Posizione_autobus() {
    }

    public Posizione_autobus(String nome, double lat, double lng) {
        this.nome = nome;
        this.lat = lat;
        this.lng = lng;
    }
