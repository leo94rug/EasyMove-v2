...
public class FeedbackRqt extends Feedback {
    ...
    public FeedbackRqt(String testo,String utente_recensito,String utente_recensore,int valutazione_guida,int valutazione_puntualita,int valutazione_disponibilita) {
