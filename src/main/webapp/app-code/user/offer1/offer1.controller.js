(function () {
    ...
    Offer1Controller.$inject = ['$timeout','$q','$scope', 'UserService', '$location', '$rootScope', '$mdpDatePicker', '$mdpTimePicker', 'AuthenticationService','$store','FlashService'];
    function Offer1Controller($timeout,$q,$scope, UserService, $location, $rootScope, $mdpDatePicker, $mdpTimePicker, AuthenticationService,$store,FlashService) {
        var vm = this;
        vm.color="red";
