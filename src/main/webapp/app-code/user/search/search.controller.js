                    ...
                    function (response, status) {
                        if (response.success === false) {
                            ...
                            if (response.rows[0].elements[0].status === 'ZERO_RESULTS') {
                                ...
                                debugger;
                                info = {
                                    lat_p: $rootScope.search.partenza.geometry.location.lat(),
                                    lat_a: $rootScope.search.arrivo.geometry.location.lat(),
                                    lng_p: $rootScope.search.partenza.geometry.location.lng(),
                                    lng_a: $rootScope.search.arrivo.geometry.location.lng(),
                                    tipo: tipo,
                                    date_search: DateService.stringFromDate($rootScope.search.date),
                                    cambio: $rootScope.search.cambio,
                                    distanza: $rootScope.search.distanza,
